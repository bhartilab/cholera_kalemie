...
This script includes the code use for sampling from the posterior distribution. You need to choose between the set of assumptions we explored (see the Supplementary Information (SI)) on:
...
The sampler requires loading other functions from the script *other_functions.R* :
...
This script includes functions necessary to run the sampler and additional functions producing the estimates to assess the impact of the intervention and explore the relative contributions of the environmental reservoir and seasonal migration.
...
* a function to produce the estimates to explore alternative vaccinatio strategies: *alternative_vaccination_strategies*. It creates a file *vacci_res.rda*, provided in */data*.
...
It is necessary to produce Figure 2 and is produced by functions available in */R code/other_functions.R*.
...
They are necessary to produce Figure 3 and are produced by functions available in */R code/other_functions.R*.
...
They are necessary to produce Figure 4 and are produced by functions available in */R code/other_functions.R*.
