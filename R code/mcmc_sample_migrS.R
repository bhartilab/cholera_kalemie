...
# replace the path toward the script "other_functions_migrS.R" on your machine
source("XXXX/R code/other_functions_migrS.R")
...
R8 = c(0, 0, 0, 0, 1) # new infected

R  = cbind(R1, R2, R3, R4, R5, R6, R7, R8)
...
# the function dXdt is defined in "other_functions_migrS.R"
