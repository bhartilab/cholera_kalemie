...
# replace the path toward the script "other_functions_migr.R" on your machine
source("XXXX/R code/other_functions_migr.R")
...
# the function dXdt is defined in "other_functions_migr.R"
