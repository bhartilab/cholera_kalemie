...
dXdt = function(times,x.input,theta.input){
  ...
  migr_S = alpha.1.input*rad_t(times)
  ...
  lam[8]  = beta.t*prod(x.input[1:2])/sum(x.input[1:3]) + beta.env.t(times)*cont.env.t*rain.amp.t*x.input[1] # contact 
